...
function logPost() {
    ...
    // Commands
    if (inputCO == "info") {
    textlog = '✨ Co Dev Web Version [v7.1] </br>';}
    ...
    if(sha1Plus == ""){textlog = '<span id="error">The command "'+ inputCO1 +'" is either misspelled orcould not be found.</span></br>';}}
    if (cmdW6 == "sha224") {
    ...
    if(sha224Plus == ""){textlog = '<span id="error">The command "'+ inputCO1 +'" is either misspelled orcould not be found.</span></br>';}}
    if (cmdW6 == "sha256") {
    ...
    if(sha256Plus == ""){textlog = '<span id="error">The command "'+ inputCO1 +'" is either misspelled orcould not be found.</span></br>';}}
    if (cmdW6 == "sha384") {
    ...
    if(sha384Plus == ""){textlog = '<span id="error">The command "'+ inputCO1 +'" is either misspelled orcould not be found.</span></br>';}}
    if (cmdW6 == "sha512") {
    ...
    if(sha512Plus == ""){textlog = '<span id="error">The command "'+ inputCO1 +'" is either misspelled orcould not be found.</span></br>';}}
    // SHAP
    if (cmdW5 == "shap1") {
    ...
    if(shap1Plus == ""){textlog = '<span id="error">The command "'+ inputCO1 +'" is either misspelled orcould not be found.</span></br>';}}
    if (cmdW7 == "shap224") {
    ...
    if(shap224Plus == ""){textlog = '<span id="error">The command "'+ inputCO1 +'" is either misspelled orcould not be found.</span></br>';}}
    if (cmdW7 == "shap256") {
    ...
    if(shap256Plus == ""){textlog = '<span id="error">The command "'+ inputCO1 +'" is either misspelled orcould not be found.</span></br>';}}
    if (cmdW7 == "shap384") {
    ...
    if(sha384pPlus == ""){textlog = '<span id="error">The command "'+ inputCO1 +'" is either misspelled orcould not be found.</span></br>';}}
    if (cmdW7 == "shap512") {
